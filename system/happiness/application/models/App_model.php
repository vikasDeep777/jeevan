...
class App_model extends CI_Model {
  ...
  function getResultById($table, $where,$limit="",$offset="",$row="", $order_by="") {
    ...
    public function sendmail($data){
	  ...
	  public function get_list_all($tablename,$limit,$offset,$id = null){	
...
//die();
			// ->join('users as U', 'U.id = E.user_id','inner');
		return $result = $this->db->get()->result();				
	}
	  public function get_list_feedback($limit,$offset,$id = null){	
	  
		$this->db->select('E.id,E.feedback,E.rated,U.first_name,U.email')
				 ->from('user_feedback as E')
				 ->join('users as U','U.id=E.user_id','inner');
		if(!empty($id)){
