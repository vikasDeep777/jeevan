...
?>                    
                    <tr>
                      ...
                      <td><?php echo htmlentities($row->rated)?></td>
                      ...
                      <td><?php // echo anchor("admin/innovative/edit/{$row->id}",' ','class="fa fa-edit"')?>
                        <?php echo  anchor("admin/feedback/get_feedback_detail/{$row->id}",' ','class="fa fa-eye"')?>
                        <?php echo  anchor("admin/feedback/deleteFeedback/{$row->id}",' ','class="fa fa-trash"')?>
